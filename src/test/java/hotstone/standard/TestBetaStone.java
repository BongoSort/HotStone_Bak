...
public class TestBetaStone {
    ...
    @Test
    public void findusShouldHave1ManaInRound1() {
        assertThat(game.getHero(Player.FINDUS).getMana(),is(1));
    }

    @Test
    public void peddersenShouldHave1ManaInRound1() {
        game.endTurn();
    ...
    @Test
    public void findusShouldHave7ManaInRound10() {
        TestHelper.advanceGameNRounds(game,10);
        assertThat(game.getHero(Player.FINDUS).getMana(),is(7));
    }

    @Test
    public void peddersenShouldHave7ManaInRound10() {
        TestHelper.advanceGameNRounds(game,10);
        assertThat(game.getHero(Player.FINDUS).getMana(),is(7));
    }
