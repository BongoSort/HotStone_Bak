...
import hotstone.variants.HeroStrategyGammaStone;
...
public class TestGammaStone {
    ...
    @BeforeEach
    public void setUp() {
        game = new StandardHotStoneGame(new ManaProductionAlphaStone(), new WinnerAlphaStone(), new HeroStrategyGammaStone());
    }
